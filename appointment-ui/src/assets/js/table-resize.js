...
function ColumnResize(table) {
	...
	this.startColumnDrag = function(e) {
		...
		for (var i=0; i<dragColumns.length; i++) {
            ...
            dragColumns[i].style.maxWidth = colWidth[i] + "px";
            var nextSibling = this.nextElementSibling;
            //var theading =  nextSibling.querySelector('.theading')
            var parentElement = this.parentNode;
            var mainParentElement = parentElement.parentNode;
            mainParentElement.classList.add("resize-th");
            nextSibling.classList.add('resize-column');
            nextSibling.width = ""; // for sure
           //var theadboxWidth = colWidth[i] - 300;
           // nextSibling.style.width = theadboxWidth  + "px";
            //theading.style.maxWidth = colWidth[i] + "px";
        }
